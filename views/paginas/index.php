...
<section class="resumen">
    <div class="resumen__grid">
        <div <?php aos_animacion(); ?> class="resumen__bloque">
            ...
            <p class="resumen__texto">Expositores</p>
        </div>
    ...
    <div class="speakers__grid">
        <?php foreach($ponentes as $ponente) { ?>
            <div <?php aos_animacion(); ?> class="speaker">
                <picture>
                    <source srcset="img/spaekers/<?php echo $ponente->imagen; ?>.webp" type="image/webp">
                    <source srcset="img/spaekers/<?php echo $ponente->imagen; ?>.png" type="image/png">
                    <img class="speaker__imagen" loading="lazy" width="200" height="300" src="img/spaekers/<?php echo $ponente->imagen; ?>.png" alt="Imagen Ponente">
                </picture>
...
<section class="boletos" >
    ...
    <div <?php aos_animacion(); ?>  data-aos-anchor-placement="top-bottom" class="boletos__grid" >
        <div  class="boleto boleto--presencial">
            <h4 class="boleto__logo">&#60;DevWebCamp /></h4>
            <p class="boleto__plan">Presencial</p>
            <p class="boleto__precio">S/39</p>
        </div>

        <div  class="boleto boleto--virtual">
            <h4 class="boleto__logo">&#60;DevWebCamp /></h4>
            <p class="boleto__plan">Virtual</p>
            <p class="boleto__precio">S/9</p>
        </div>
